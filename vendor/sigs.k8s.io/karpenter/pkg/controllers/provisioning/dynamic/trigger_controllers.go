...
func NewPodController(kubeClient client.Client, provisioningController *ProvisioningController, cluster *state.Cluster) *PodController {
...
func NewNodeController(kubeClient client.Client, provisioningController *ProvisioningController) *NodeController {
